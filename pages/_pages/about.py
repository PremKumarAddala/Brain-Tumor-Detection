...
def main():
    ...
    cleaned using the [mask.py](https://github.com/PremKumarAddala/brain-tumor-detection/blob/main/model/mask.py)
    ...
    loaded using the [get_model(num)](https://github.com/PremKumarAddala/brain-tumor-detection/blob/f13044f11e797a90ed73b2bbe94ab7a7502f02f5/model/predictor.py#L24)
    ...
    cancers diagnosed using similar methods (e.g., MRI). The program features a graphic interface built using Streamlit 
    and is hosted at [Streamlit App](https://share.streamlit.io/PremKumarAddala/brain-tumor-detection/main/app.py). 
    The source code is available at [GitHub](https://github.com/PremKumarAddala/brain-tumor-detection).
    """
